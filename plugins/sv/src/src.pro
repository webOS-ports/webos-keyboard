...
lang_db_sv.commands += \
  ...
  text2ngram -n 1 -l -f sqlite -o $$lang_db_sv.files $$PWD/tatoeba_sv.txt && \
  text2ngram -n 2 -l -f sqlite -o $$lang_db_sv.files $$PWD/tatoeba_sv.txt && \
  text2ngram -n 3 -l -f sqlite -o $$lang_db_sv.files $$PWD/tatoeba_sv.txt && \
