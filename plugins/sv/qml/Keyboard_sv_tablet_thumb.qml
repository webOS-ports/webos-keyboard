...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey2; label: "e"; shifted: "E"; extended: ["e", "è", "é", "ê", "ë", "ę", "ē", "€"]; extendedShifted: ["E", "È", "É", "Ê", "Ë", "Ę", "Ē", "€"]; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            CharKey { id: topKey3; label: "r"; shifted: "R"; extended: ["r", "®"]; extendedShifted: ["R","®"]; width: Units.gu(3.9); anchors.left: topKey2.right; thumbKeyboard: true }
            CharKey { id: topKey4; label: "t"; shifted: "T"; extended: ["t", "™", "þ"]; extendedShifted: ["T", "™", "Þ"]; width: Units.gu(3.9); anchors.left: topKey3.right; thumbKeyboard: true }
        ...
        Item {
            ...
            CharKey { id: midKey1; label: "s"; shifted: "S"; extended: ["s", "š", "ş", "ß", "σ", "$"]; extendedShifted: ["S", "Š", "Ş", "ß", "Σ", "$"]; width: Units.gu(3.9); anchors.left: midKey0.right; thumbKeyboard: true }
            CharKey { id: midKey2; label: "d"; shifted: "D"; extended: ["d", "ð", "†", "‡"]; extendedShifted: ["D", "Ð", "†", "‡"]; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: midKey8; label: "l"; shifted: "L"; extended: ["l", "ł"]; extendedShifted: ["L", "Ł"]; width: Units.gu(3.9); anchors.right: midKey9.left; thumbKeyboard: true }
