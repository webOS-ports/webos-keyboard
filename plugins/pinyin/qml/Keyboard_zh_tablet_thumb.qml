...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey0; label: "q"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: topKey1; label: "w"; width: Units.gu(3.9); anchors.left: topKey0.right; thumbKeyboard: true }
            CharKey { id: topKey2; label: "e"; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            CharKey { id: topKey3; label: "r"; width: Units.gu(3.9); anchors.left: topKey2.right; thumbKeyboard: true }
            CharKey { id: topKey4; label: "t"; width: Units.gu(3.9); anchors.left: topKey3.right; thumbKeyboard: true }
            CharKey { id: topKey5; label: "y"; width: Units.gu(3.9); anchors.right: topKey6.left; thumbKeyboard: true }
            CharKey { id: topKey6; label: "u"; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            CharKey { id: topKey7; label: "i"; width: Units.gu(3.9); anchors.right: topKey8.left; thumbKeyboard: true }
            CharKey { id: topKey8; label: "o"; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
            CharKey { id: topKey9; label: "p"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "a"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: midKey1; label: "s"; width: Units.gu(3.9); anchors.left: midKey0.right; thumbKeyboard: true }
            CharKey { id: midKey2; label: "d"; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            CharKey { id: midKey3; label: "f"; width: Units.gu(3.9); anchors.left: midKey2.right; thumbKeyboard: true }
            CharKey { id: midKey4; label: "g"; width: Units.gu(3.9); anchors.left: midKey3.right; thumbKeyboard: true }
            CharKey { id: midKey5; label: "h"; width: Units.gu(3.9); anchors.right: midKey6.left; thumbKeyboard: true }
            CharKey { id: midKey6; label: "j"; width: Units.gu(3.9); anchors.right: midKey7.left; thumbKeyboard: true }
            CharKey { id: midKey7; label: "k"; width: Units.gu(3.9); anchors.right: midKey8.left; thumbKeyboard: true }
            CharKey { id: midKey8; label: "l"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: lowKey0; label: "z"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: lowKey1; label: "x"; width: Units.gu(3.9); anchors.left: lowKey0.right; thumbKeyboard: true }
            CharKey { id: lowKey2; label: "c"; width: Units.gu(3.9); anchors.left: lowKey1.right; thumbKeyboard: true }
            CharKey { id: lowKey3; label: "v"; width: Units.gu(3.9); anchors.left: lowKey2.right; thumbKeyboard: true }
            CharKey { id: lowKey4; label: "b"; width: Units.gu(3.9); anchors.left: lowKey3.right; thumbKeyboard: true }
            CharKey { id: lowKey5; label: "n"; width: Units.gu(3.9); anchors.right: lowKey6.left; thumbKeyboard: true }
            CharKey { id: lowKey6; label: "m"; width: Units.gu(3.9); anchors.right: lowKey7.left; thumbKeyboard: true }
            ...
            AnnotatedKey { id: lowKey8; label: "。"; shifted: "。"; width: Units.gu(3.9); anchors.right: lowKey9.left; thumbKeyboard: true }
