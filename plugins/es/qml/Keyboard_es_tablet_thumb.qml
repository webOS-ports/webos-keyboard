...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey10; label: "ç"; shifted: "Ç"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey9; label: "ñ"; shifted: "Ñ"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
