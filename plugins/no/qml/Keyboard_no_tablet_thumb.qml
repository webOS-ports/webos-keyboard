...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey5; label: "y"; shifted: "Y"; extended: ["y", "ý", "ÿ", "¥"]; extendedShifted: ["Y", "Ý", "Ÿ", "¥"]; width: Units.gu(3.9); anchors.left: topKey4.right; thumbKeyboard: true }
            ...
            CharKey { id: topKey10; label: "å"; shifted: "Å"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey9; label: "ø"; shifted: "Ø"; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: "æ"; shifted: "Æ"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: lowKey0; label: "z"; shifted: "Z"; extended: ["z", "ž", "ź", "ż"]; extendedShifted: ["Z", "Ž", "Ź", "Ż"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
