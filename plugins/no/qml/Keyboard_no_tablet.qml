...
/*
 * Weights follow tabletkeymaps/no.h, sNoQwertyLayout. Row sums: 12 / 13 / 12.2 / 11.8 / 11.
 * Identical to the Danish keymap except for the tail of the home row, where the
 * reference puts o-slash before ash.
 */
...
KeyPad {
    ...
    Column {
        ...
        // NO_QWERTY_NUMBERS_10(1) + KEY_1(2, cKey_Trackball)  [sum 12]
        KeyRow {
        ...
        // NO_QWERTY_TOP_11(1) + KEY_1(2, Backspace)  [sum 13]
        KeyRow {
            height: keyHeight
        ...
        // KEY_2(-0.2, A, Less) + NO_QWERTY_MID_11(1) + KEY_1(1, Return)  [sum 12.2]
        KeyRow {
            height: keyHeight
