...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            LanguageKey    { id: languageMenuButton; label: "en";                   anchors.left: symShiftKey.right; }
            ...
            ReturnKey      { id: enterKey; label: "Enter"; shifted: "Enter"; anchors.right: dismissKey.left; }
            DismissKey      { id: dismissKey; label: "Hide"; shifted: "Hide"; anchors.right: parent.right; }
        }
    } // column
}
