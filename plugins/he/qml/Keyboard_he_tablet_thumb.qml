...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey0; label: "/"; shifted: "Q"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: topKey1; label: "'"; shifted: "W"; width: Units.gu(3.9); anchors.left: topKey0.right; thumbKeyboard: true }
            CharKey { id: topKey2; label: "ק"; shifted: "E"; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            CharKey { id: topKey3; label: "ר"; shifted: "R"; width: Units.gu(3.9); anchors.left: topKey2.right; thumbKeyboard: true }
            CharKey { id: topKey4; label: "א"; shifted: "T"; width: Units.gu(3.9); anchors.left: topKey3.right; thumbKeyboard: true }
            CharKey { id: topKey5; label: "ט"; shifted: "Y"; width: Units.gu(3.9); anchors.left: topKey4.right; thumbKeyboard: true }
            CharKey { id: topKey6; label: "ו"; shifted: "U"; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            CharKey { id: topKey7; label: "ן"; shifted: "I"; width: Units.gu(3.9); anchors.right: topKey8.left; thumbKeyboard: true }
            CharKey { id: topKey8; label: "ם"; shifted: "O"; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
            CharKey { id: topKey9; label: "פ"; shifted: "P"; width: Units.gu(3.9); anchors.right: topKey10.left; thumbKeyboard: true }
            CharKey { id: topKey10; label: "]"; shifted: "}"; width: Units.gu(3.9); anchors.right: topKey11.left; thumbKeyboard: true }
            CharKey { id: topKey11; label: "["; shifted: "{"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "ש"; shifted: "A"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: midKey1; label: "ד"; shifted: "S"; width: Units.gu(3.9); anchors.left: midKey0.right; thumbKeyboard: true }
            CharKey { id: midKey2; label: "ג"; shifted: "D"; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            CharKey { id: midKey3; label: "כ"; shifted: "F"; width: Units.gu(3.9); anchors.left: midKey2.right; thumbKeyboard: true }
            CharKey { id: midKey4; label: "ע"; shifted: "G"; width: Units.gu(3.9); anchors.left: midKey3.right; thumbKeyboard: true }
            CharKey { id: midKey5; label: "י"; shifted: "H"; width: Units.gu(3.9); anchors.left: midKey4.right; thumbKeyboard: true }
            CharKey { id: midKey6; label: "ח"; shifted: "J"; width: Units.gu(3.9); anchors.right: midKey7.left; thumbKeyboard: true }
            CharKey { id: midKey7; label: "ל"; shifted: "K"; width: Units.gu(3.9); anchors.right: midKey8.left; thumbKeyboard: true }
            CharKey { id: midKey8; label: "ך"; shifted: "L"; width: Units.gu(3.9); anchors.right: midKey9.left; thumbKeyboard: true }
            CharKey { id: midKey9; label: "ף"; shifted: ":"; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: ","; shifted: "\""; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: lowKey0; label: "ז"; shifted: "Z"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: lowKey1; label: "ס"; shifted: "X"; width: Units.gu(3.9); anchors.left: lowKey0.right; thumbKeyboard: true }
            CharKey { id: lowKey2; label: "ב"; shifted: "C"; width: Units.gu(3.9); anchors.left: lowKey1.right; thumbKeyboard: true }
            CharKey { id: lowKey3; label: "ה"; shifted: "V"; width: Units.gu(3.9); anchors.left: lowKey2.right; thumbKeyboard: true }
            CharKey { id: lowKey4; label: "נ"; shifted: "B"; width: Units.gu(3.9); anchors.left: lowKey3.right; thumbKeyboard: true }
            CharKey { id: lowKey5; label: "מ"; shifted: "N"; width: Units.gu(3.9); anchors.left: lowKey4.right; thumbKeyboard: true }
            CharKey { id: lowKey6; label: "צ"; shifted: "M"; width: Units.gu(3.9); anchors.right: lowKey7.left; thumbKeyboard: true }
            CharKey { id: lowKey7; label: "ת"; shifted: "<"; width: Units.gu(3.9); anchors.right: lowKey8.left; thumbKeyboard: true }
            CharKey { id: lowKey8; label: "ץ"; shifted: ">"; width: Units.gu(3.9); anchors.right: lowKey9.left; thumbKeyboard: true }
