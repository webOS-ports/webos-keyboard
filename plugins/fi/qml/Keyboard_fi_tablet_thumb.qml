...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: lowKey2; label: "c"; shifted: "C"; extended: ["c", "ç", "ć", "©", "¢"]; extendedShifted: ["C", "Ç", "Ć", "©", "¢"]; width: Units.gu(3.9); anchors.left: lowKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: lowKey5; label: "n"; shifted: "N"; extended: ["n", "ñ", "ń"]; extendedShifted: ["N", "Ñ", "Ń"]; width: Units.gu(3.9); anchors.right: lowKey6.left; thumbKeyboard: true }
