...
lang_db_ar.commands += \
  ...
  text2ngram -n 1 -l -f sqlite -o $$lang_db_ar.files $$PWD/tatoeba_ar.txt && \
  text2ngram -n 2 -l -f sqlite -o $$lang_db_ar.files $$PWD/tatoeba_ar.txt && \
  text2ngram -n 3 -l -f sqlite -o $$lang_db_ar.files $$PWD/tatoeba_ar.txt && \
