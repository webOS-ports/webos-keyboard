...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey0; label: "ض"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: topKey1; label: "ص"; width: Units.gu(3.9); anchors.left: topKey0.right; thumbKeyboard: true }
            CharKey { id: topKey2; label: "ث"; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            CharKey { id: topKey3; label: "ق"; width: Units.gu(3.9); anchors.left: topKey2.right; thumbKeyboard: true }
            CharKey { id: topKey4; label: "ف"; width: Units.gu(3.9); anchors.left: topKey3.right; thumbKeyboard: true }
            CharKey { id: topKey5; label: "غ"; shifted: "إ"; width: Units.gu(3.9); anchors.left: topKey4.right; thumbKeyboard: true }
            CharKey { id: topKey6; label: "ع"; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            CharKey { id: topKey7; label: "ه"; width: Units.gu(3.9); anchors.right: topKey8.left; thumbKeyboard: true }
            CharKey { id: topKey8; label: "خ"; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
            CharKey { id: topKey9; label: "ح"; width: Units.gu(3.9); anchors.right: topKey10.left; thumbKeyboard: true }
            CharKey { id: topKey10; label: "ج"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "ش"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: midKey1; label: "س"; width: Units.gu(3.9); anchors.left: midKey0.right; thumbKeyboard: true }
            CharKey { id: midKey2; label: "ي"; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            CharKey { id: midKey3; label: "ب"; width: Units.gu(3.9); anchors.left: midKey2.right; thumbKeyboard: true }
            CharKey { id: midKey4; label: "ل"; width: Units.gu(3.9); anchors.left: midKey3.right; thumbKeyboard: true }
            CharKey { id: midKey5; label: "ا"; shifted: "أ"; width: Units.gu(3.9); anchors.left: midKey4.right; thumbKeyboard: true }
            CharKey { id: midKey6; label: "ت"; width: Units.gu(3.9); anchors.right: midKey7.left; thumbKeyboard: true }
            CharKey { id: midKey7; label: "ن"; width: Units.gu(3.9); anchors.right: midKey8.left; thumbKeyboard: true }
            CharKey { id: midKey8; label: "م"; width: Units.gu(3.9); anchors.right: midKey9.left; thumbKeyboard: true }
            CharKey { id: midKey9; label: "ك"; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: "د"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: lowKey0; label: "ئ"; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: lowKey1; label: "ء"; width: Units.gu(3.9); anchors.left: lowKey0.right; thumbKeyboard: true }
            CharKey { id: lowKey2; label: "ؤ"; width: Units.gu(3.9); anchors.left: lowKey1.right; thumbKeyboard: true }
            CharKey { id: lowKey3; label: "ر"; width: Units.gu(3.9); anchors.left: lowKey2.right; thumbKeyboard: true }
            CharKey { id: lowKey4; label: "ى"; shifted: "آ"; width: Units.gu(3.9); anchors.left: lowKey3.right; thumbKeyboard: true }
            CharKey { id: lowKey5; label: "ة"; width: Units.gu(3.9); anchors.right: lowKey6.left; thumbKeyboard: true }
            CharKey { id: lowKey6; label: "و"; width: Units.gu(3.9); anchors.right: lowKey7.left; thumbKeyboard: true }
            CharKey { id: lowKey7; label: "ز"; width: Units.gu(3.9); anchors.right: lowKey8.left; thumbKeyboard: true }
            CharKey { id: lowKey8; label: "ظ"; width: Units.gu(3.9); anchors.right: lowKey9.left; thumbKeyboard: true }
