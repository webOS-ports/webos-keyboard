...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey2; label: "e"; shifted: "E"; extended: ["ę","é","ě","€"]; extendedShifted: ["Ę","É","Ě","€"]; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: topKey5; label: "y"; shifted: "Y"; extended: ["¥"]; extendedShifted: ["¥"]; width: Units.gu(3.9); anchors.left: topKey4.right; thumbKeyboard: true }
            CharKey { id: topKey6; label: "u"; shifted: "U"; extended: ["ü","ú","ů","ű"]; extendedShifted: ["Ü","Ú","Ů","Ű"]; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            ...
            CharKey { id: topKey8; label: "o"; shifted: "O"; extended: ["ó","ö","ô","ő"]; extendedShifted: ["Ó","Ö","Ô","Ő"]; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
            CharKey { id: topKey9; label: "p"; shifted: "P"; width: Units.gu(3.9); anchors.right: topKey10.left; thumbKeyboard: true }
            CharKey { id: topKey10; label: "ż"; shifted: "Ż"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "a"; shifted: "A"; extended: ["ą","ä","á","â","ă"]; extendedShifted: ["Ą","Ä","Á","Â","Ă"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: midKey1; label: "s"; shifted: "S"; extended: ["ś","ß","ş","š","$"]; extendedShifted: ["Ś","Ş","Š","$"]; width: Units.gu(3.9); anchors.left: midKey0.right; thumbKeyboard: true }
            CharKey { id: midKey2; label: "d"; shifted: "D"; extended: ["ď","đ"]; extendedShifted: ["Ď","Đ"]; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: midKey8; label: "l"; shifted: "L"; extended: ["ł","ľ","ĺ"]; extendedShifted: ["Ł","Ľ","Ĺ"]; width: Units.gu(3.9); anchors.right: midKey9.left; thumbKeyboard: true }
            CharKey { id: midKey9; label: "ł"; shifted: "Ł"; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: "ą"; shifted: "Ą"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: lowKey0; label: "z"; shifted: "Z"; extended: ["ż","ź","ž"]; extendedShifted: ["Ż","Ź","Ž"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: lowKey1; label: "x"; shifted: "X"; width: Units.gu(3.9); anchors.left: lowKey0.right; thumbKeyboard: true }
            CharKey { id: lowKey2; label: "c"; shifted: "C"; extended: ["ć","č","ç"]; extendedShifted: ["Ć","Č","Ç"]; width: Units.gu(3.9); anchors.left: lowKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: lowKey5; label: "n"; shifted: "N"; extended: ["ń","ň","ñ"]; extendedShifted: ["Ń","Ň","Ñ"]; width: Units.gu(3.9); anchors.left: lowKey4.right; thumbKeyboard: true }
            CharKey { id: lowKey6; label: "m"; shifted: "M"; width: Units.gu(3.9); anchors.right: lowKey7.left; thumbKeyboard: true }
            CharKey { id: lowKey7; label: "ę"; shifted: "Ę"; width: Units.gu(3.9); anchors.right: lowKey8.left; thumbKeyboard: true }
