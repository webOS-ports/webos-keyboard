...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: cKey; anchors.left: xKey.right; width: UI.keyWidth * 11/9; label: "c"; shifted: "C"; extended: ["c", "ç", "ć", "©", "¢", "č"]; extendedShifted: ["C", "Ç", "Ć", "©", "¢", "Č"]; }
            ...
            CharKey { id: nKey; anchors.left: bKey.right; width: UI.keyWidth * 11/9; label: "n"; shifted: "N"; extended: ["n", "ñ", "ń", "ň"]; extendedShifted: ["N", "Ñ", "Ń", "Ň"]; }
