...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: midKey9; label: "æ"; shifted: "Æ"; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: "ø"; shifted: "Ø"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
