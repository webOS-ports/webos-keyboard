...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey6; label: "u"; shifted: "U"; extended: ["u", "û", "ù", "ú", "û", "ü", "ű"]; extendedShifted: ["U", "Û","Ù","Ú","Û", "Ü", "Ű"]; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            ...
            CharKey { id: topKey10; label: "ü"; shifted: "Ü"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey9; label: "ö"; shifted: "Ö"; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: "ä"; shifted: "Ä"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
