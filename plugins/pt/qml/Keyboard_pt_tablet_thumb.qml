...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey2; label: "e"; shifted: "E"; extended: ["é","ê","è","ë","€"]; extendedShifted: ["É","Ê","È","Ë","€"]; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: topKey5; label: "y"; shifted: "Y"; extended: ["ý", "¥", "ÿ"]; extendedShifted: ["Ý", "¥", "Ÿ"]; width: Units.gu(3.9); anchors.right: topKey6.left; thumbKeyboard: true }
            CharKey { id: topKey6; label: "u"; shifted: "U"; extended: ["ú","û","ù","ü"]; extendedShifted: ["Ú","Û","Ù","Ü"]; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            CharKey { id: topKey7; label: "i"; shifted: "I"; extended: ["í","î","ì","ï"]; extendedShifted: ["Í","Î","Ì","Ï"]; width: Units.gu(3.9); anchors.right: topKey8.left; thumbKeyboard: true }
            CharKey { id: topKey8; label: "o"; shifted: "O"; extended: ["ó","õ","ô","º","ò","ö"]; extendedShifted: ["Ó","Õ","Ô","º","Ò","Ö"]; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "a"; shifted: "A"; extended: ["ã","á","à","â","ª","ä","å","æ"]; extendedShifted: ["Ã","Á","À","Â","ª","Ä","Å","Æ"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            ...
            CharKey { id: midKey2; label: "d"; shifted: "D"; extended: ["ð"]; extendedShifted: ["Ð"]; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: midKey9; label: "ç"; shifted: "Ç"; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
