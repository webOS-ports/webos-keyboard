...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey2; label: "e"; shifted: "E"; extended: ["ë","è","é","ê","€"]; extendedShifted: ["Ë","È","É","Ê","€"]; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: topKey6; label: "u"; shifted: "U"; extended: ["û","ù","ü","ú"]; extendedShifted: ["Û","Ù","Ü","Ú"]; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            CharKey { id: topKey7; label: "i"; shifted: "I"; extended: ["ï","î","ì","í"]; extendedShifted: ["Ï","Î","Ì","Í"]; width: Units.gu(3.9); anchors.right: topKey8.left; thumbKeyboard: true }
            CharKey { id: topKey8; label: "o"; shifted: "O"; extended: ["ô","ò","ö","ó","õ"]; extendedShifted: ["Ô","Ò","Ö","Ó","Õ"]; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "a"; shifted: "A"; extended: ["à","â","æ","ä","á","ã",]; extendedShifted: ["À","Â","Æ","Ä","Á","Ã"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
