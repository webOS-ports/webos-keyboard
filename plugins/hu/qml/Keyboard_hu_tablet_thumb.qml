...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            CharKey { id: topKey2; label: "e"; shifted: "E"; extended: ["é","ę","ě","€"]; extendedShifted: ["É","Ę","Ě","€"]; width: Units.gu(3.9); anchors.left: topKey1.right; thumbKeyboard: true }
            CharKey { id: topKey3; label: "r"; shifted: "R"; extended: ["ŕ","ř"]; extendedShifted: ["Ŕ","Ř"]; width: Units.gu(3.9); anchors.left: topKey2.right; thumbKeyboard: true }
            CharKey { id: topKey4; label: "t"; shifted: "T"; extended: ["ţ","ť"]; extendedShifted: ["Ţ","Ť"]; width: Units.gu(3.9); anchors.left: topKey3.right; thumbKeyboard: true }
            CharKey { id: topKey5; label: "z"; shifted: "Z"; extended: ["ź","ż", "ž"]; extendedShifted: ["Ź","Ż","Ž"]; width: Units.gu(3.9); anchors.left: topKey4.right; thumbKeyboard: true }
            CharKey { id: topKey6; label: "u"; shifted: "U"; extended: ["ú","ü","ű","ů"]; extendedShifted: ["Ú","Ü","Ű","Ů"]; width: Units.gu(3.9); anchors.right: topKey7.left; thumbKeyboard: true }
            CharKey { id: topKey7; label: "i"; shifted: "I"; extended: ["í","î"]; extendedShifted: ["Í","Î"]; width: Units.gu(3.9); anchors.right: topKey8.left; thumbKeyboard: true }
            CharKey { id: topKey8; label: "o"; shifted: "O"; extended: ["ó","ö","ő","ô"]; extendedShifted: ["Ó","Ö","Ő","Ô"]; width: Units.gu(3.9); anchors.right: topKey9.left; thumbKeyboard: true }
            CharKey { id: topKey9; label: "p"; shifted: "P"; width: Units.gu(3.9); anchors.right: topKey10.left; thumbKeyboard: true }
            CharKey { id: topKey10; label: "ő"; shifted: "Ő"; extended: ["ő", "ö", "ó", "ô"]; extendedShifted: ["Ő", "Ö", "Ó", "Ô"]; width: Units.gu(3.9); anchors.right: topKey11.left; thumbKeyboard: true }
            CharKey { id: topKey11; label: "ú"; shifted: "Ú"; extended: ["ú", "ü", "ű", "ů"]; extendedShifted: ["Ú", "Ü", "Ű", "Ů"]; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: midKey0; label: "a"; shifted: "A"; extended: ["á","ä","â","ă","ą"]; extendedShifted: ["Á","Ä","Â","Ă","Ą"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: midKey1; label: "s"; shifted: "S"; extended: ["ß","ś","ş","š","$"]; extendedShifted: ["ß","Ś","Ş","Š","$"]; width: Units.gu(3.9); anchors.left: midKey0.right; thumbKeyboard: true }
            CharKey { id: midKey2; label: "d"; shifted: "D"; extended: ["đ","ď"]; extendedShifted: ["Đ","Ď"]; width: Units.gu(3.9); anchors.left: midKey1.right; thumbKeyboard: true }
            ...
            CharKey { id: midKey5; label: "h"; shifted: "H"; width: Units.gu(3.9); anchors.left: midKey4.right; thumbKeyboard: true }
            ...
            CharKey { id: midKey8; label: "l"; shifted: "L"; width: Units.gu(3.9); anchors.right: midKey9.left; thumbKeyboard: true }
            CharKey { id: midKey9; label: "é"; shifted: "É"; extended: ["é", "è", "ê", "ë"]; extendedShifted: ["É", "È", "Ê", "Ë"]; width: Units.gu(3.9); anchors.right: midKey10.left; thumbKeyboard: true }
            CharKey { id: midKey10; label: "á"; shifted: "Á"; extended: ["á", "à", "â", "ä"]; extendedShifted: ["Á", "À", "Â", "Ä"]; width: Units.gu(3.9); anchors.right: midKey11.left; thumbKeyboard: true }
            CharKey { id: midKey11; label: "ű"; shifted: "Ű"; extended: ["ű", "ü", "ú", "ù"]; extendedShifted: ["Ű", "Ü", "Ú", "Ù"]; width: Units.gu(3.9); anchors.right: parent.right; thumbKeyboard: true }
        }
        ...
        Item {
            ...
            CharKey { id: lowKey0; label: "í"; shifted: "Í"; extended: ["í", "ì", "î", "ï"]; extendedShifted: ["Í", "Ì", "Î", "Ï"]; width: Units.gu(3.9); anchors.left: parent.left; thumbKeyboard: true }
            CharKey { id: lowKey1; label: "y"; shifted: "Y"; extended: ["¥"]; extendedShifted: ["¥"]; width: Units.gu(3.9); anchors.left: lowKey0.right; thumbKeyboard: true }
            CharKey { id: lowKey2; label: "x"; shifted: "X"; width: Units.gu(3.9); anchors.left: lowKey1.right; thumbKeyboard: true }
            CharKey { id: lowKey3; label: "c"; shifted: "C"; extended: ["ć","č","ç"]; extendedShifted: ["Ć","Č","Ç"]; width: Units.gu(3.9); anchors.left: lowKey2.right; thumbKeyboard: true }
            CharKey { id: lowKey4; label: "v"; shifted: "V"; width: Units.gu(3.9); anchors.left: lowKey3.right; thumbKeyboard: true }
            CharKey { id: lowKey5; label: "b"; shifted: "B"; width: Units.gu(3.9); anchors.left: lowKey4.right; thumbKeyboard: true }
            CharKey { id: lowKey6; label: "n"; shifted: "N"; extended: ["ń","ň","ñ"]; extendedShifted: ["Ń","Ň","Ñ"]; width: Units.gu(3.9); anchors.right: lowKey7.left; thumbKeyboard: true }
            CharKey { id: lowKey7; label: "m"; shifted: "M"; width: Units.gu(3.9); anchors.right: lowKey8.left; thumbKeyboard: true }
