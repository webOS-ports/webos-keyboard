...
//!
//!   QT_LOGGING_RULES="luneos.keyboard.keys.info=true"
//!
...
//!
//! Info and not debug on purpose: LuneOS installs a pmlog message handler that
//! drops QtDebugMsg outright, so qCDebug() never reaches the journal here no
//! matter what the rules say - verified with *.debug=true, which produced
//! nothing at all.
...
//!
//!   QT_LOGGING_RULES="luneos.keyboard.hw.info=true"
